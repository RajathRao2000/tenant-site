      ...
      <div className="w-full lg:w-[383px]">
        <div className="bg-white border border-slate-200 p-3 rounded-2xl shadow-sm">
          ...
          <div className="border-t border-slate-100 pt-3 flex gap-4">
           <a
  href="#"
  className="flex items-center gap-2 text-green-600 font-bold text-[17px] hover:text-green-700 transition-colors"
>
<svg role="img" className="size-6 text-6xl gap-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z" />
            ...
            <div className="flex items-center  text-slate-700 text-x lg:text-x">
      ...
      <div className="sticky top-4 bg-white border border-slate-200 p-6 rounded-2xl shadow-sm h-fit">
        ...
        <div className="flex justify-between items-start mb-6">
          ...
          <div>
            ...
            <p className="text-ornage-600 font-bold text-3xl text-left">
              $7,469
            </p>
          </div>
        </div>
        ...
        <div className="border-t pt-4">
          ...
          <div className="relative w-full mb-3">
            <div
              id="countryDropdown"
              className="flex items-center justify-between border-2 border-slate-100 p-2.5 rounded-lg bg-white shadow-sm cursor-pointer hover:border-slate-200 transition-all"
            >
          ...
          <div className="space-y-2">
            <select
              ...
              className="w-full border-2 border-slate-100 p-2 rounded-lg text-sm font-bold outline-none"
            >
            ...
            <div className="relative w-full">
              ...
              <input
                ...
                id="fobInput"
                oninput="checkInputs()"
                placeholder="Vehicle FOB Value"
                className="w-full border-2 border-slate-100 p-2 pl-7 rounded-lg text-sm font-bold text-slate-800 outline-none focus:border-blue-500"
              />
            </div>
            <button
              id="calcBtn"
              onclick="showResults()"
              className="w-full bg-slate-300 cursor-not-allowed text-white font-bold py-2.5 rounded-lg transition text-sm"
              disabled=""
            >
              CALCULATE SHIPPING COST
            </button>
          ...
          <div
            ...
            className="hidden mt-4 space-y-2 border-t pt-4"
          >
            ...
            <div className="space-y-1 text-xs">
              <div className="flex justify-between">
                <span>Freight:</span> <span className="font-bold">$1,013</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                <span>Insurance:</span> <span className="font-bold">$158</span>
              </div>
              <div className="flex justify-between">
                <span>Handling Fee:</span>{" "}
                <span className="font-bold">$113</span>
              </div>
              <div className="flex justify-between pt-2 border-t font-bold text-slate-800 text-sm">
                <span>Total:</span>{" "}
                <span className="text-green-600">$1,378</span>
              </div>
            </div>
            <button className="w-full bg-blue-600 text-white font-bold py-2 rounded-lg hover:bg-blue-700 transition text-xs uppercase mt-2">
              Get a Free Quote
            </button>
          </div>
        </div>
        <button className="w-full mt-4 bg-green-500 text-white font-bold py-2.5 rounded-lg transition text-sm">
          TALK TO US
        </button>
      </div>
    </div>
    ...
    <section className="w-full bg-slate-50 py-3 font-poppins">
      <div className="max-w-7xl mx-auto p-4 md:p-6">
        {/* Header */}
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-[#1E3A8A] uppercase inline-block border-b-2 border-orange-400 pb-1">
            Payment Methods
          </h2>
        </div>
        {/* Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* Bank Transfer */}
          <div className="border border-slate-200 p-6 rounded-2xl flex items-center gap-4 shadow-sm hover:shadow-md transition-all duration-300 bg-white">
            <img
              src="/bank.png"
          ...
          <div className="border border-slate-200 p-6 rounded-2xl flex items-center gap-4 shadow-sm hover:shadow-md transition-all duration-300 bg-white">
            <img
              src="/car-trde-suite-paypal.png"
              className="h-16 w-16 object-contain"
              alt="PayPal"
            />
            <span className="text-lg font-bold text-slate-700">PayPal</span>
          </div>
        </div>
      </div>
    </section>
